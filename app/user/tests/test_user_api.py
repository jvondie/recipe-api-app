...
class PublicUserApiTests(TestCase):
    ...
    def test_password_too_short_error(self):
        """Test that an error is returned if PW is less than 5 chars"""
        payload = {
            'email': 'test@example.com',
            'password': 'pw',
            'name': 'Test Name'
    ...
    def test_create_token_blank_password(self):
        """Tests posting a blank password returns and error"""
...
class PrivateUserApiTests(TestCase):
    """Test API requests that require authenticateion"""
